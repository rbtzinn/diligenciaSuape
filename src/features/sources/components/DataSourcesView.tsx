...
export const DataSourcesView: React.FC = () => {
  ...
  const sources: SourceInfo[] = [
    ...
    },
    {
      ...
      statusLabel: webSearchConfigured ? 'Configurada' : webSearchConfigured === false ? 'Não configurada' : 'Status indisponível',
    ...
    },
    {
      ...
      statusLabel: datajudConfigured ? 'Configurada' : datajudConfigured === false ? 'Não configurada' : 'Status indisponível',
